...
const Sidebar = () => {
  ...
  <ul className={styles.sidebarNavigation}>
    ...
    <li>
      <a href="/manage" className={!routerPath ? styles.active : null}>
      <i class="bi bi-house"></i>Home
      </a>
    </li>
    <li>
      <a href="/manage/books" className={routerPath === "books" ? styles.active : null}>
      <i class="bi bi-book"></i>Books
      </a>
    </li>
    <li>
      <a href="/manage/members" className={routerPath === "members" ? styles.active : null}>
      <i class="bi bi-person"></i>Members
      </a>
    </li>
    <li>
